        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #007bff; color: white;">
                    ...
                    <a href="{{ route('proveedores.create') }}" class="btn btn-warning btn-lg">Agregar Proveedor</a>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" style="background-color: #ffffff;">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col" style="background-color: #6c757d; color: #fff;">ID Proveedor</th>
                            ...
                            <tbody>
                                @foreach ($proveedores as $proveedor)
                                    <tr>
                                        <td style="background-color: #6c757d; color: #fff;">{{ $proveedor->id_proveedor }}</td>
                                        <td>
                                            <a class="btn btn-info btn-sm" href="{{ route('proveedores.show', $proveedor->id_proveedor) }}" style="background-color: #007bff; color: #fff; font-weight: bold;">Mostrar</a>
                                            <a class="btn btn-primary btn-sm" href="{{ route('proveedores.edit', $proveedor->id_proveedor) }}" style="background-color: #0069d9; border-color: #0062cc; color: #fff; font-weight: bold;">Editar</a>
